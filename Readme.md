...
# Parsing + Configuration Script – Evaporador - Rev. A

This **Parsing + Configuration** script is designed for the **Evaporador** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Evaporador Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Evaporador** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
